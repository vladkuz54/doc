...
def add_video_form(request: Request):
    return templates.TemplateResponse("material/video_form.html", {
        "request": request, "action_title": "Add video",
...
def add_video(
    ...
    data = VideoSchema(
        title=title, estimated_time=estimated_time, is_mandatory=is_mandatory,
        release_date=release_date, module_id=module_id, url=url,
        is_watched=is_watched, duration_seconds=duration_seconds, has_subtitles=has_subtitles,
    )
...
def edit_video_form(material_id: int, request: Request, service: MaterialService = Depends(get_material_service)):
    ...
    return templates.TemplateResponse("material/video_form.html", {
        "request": request, "action_title": "Edit video",
...
def edit_video(
    ...
    service.update(material_id, data.model_dump())
    return RedirectResponse(url="/material/video", status_code=303)
...
def add_text_form(request: Request):
    return templates.TemplateResponse("material/text_form.html", {
        "request": request, "action_title": "Add text",
...
def add_text(
    ...
    data = TextSchema(
        title=title, estimated_time=estimated_time, is_mandatory=is_mandatory,
        release_date=release_date, module_id=module_id, body=body,
        is_read=is_read, reading_time_minutes=reading_time_minutes,
...
def edit_text_form(material_id: int, request: Request, service: MaterialService = Depends(get_material_service)):
    material = service.get_by_id(material_id)
    return templates.TemplateResponse("material/text_form.html", {
        "request": request, "action_title": "Edit text",
...
def add_test_form(request: Request):
    return templates.TemplateResponse("material/test_form.html", {
        "request": request, "action_title": "Add test",
...
def add_test(
    ...
    data = TestSchema(
        title=title, estimated_time=estimated_time, is_mandatory=is_mandatory,
        release_date=release_date, module_id=module_id, score=score,
        passing_score=passing_score, is_passed=is_passed,
...
def edit_test_form(material_id: int, request: Request, service: MaterialService = Depends(get_material_service)):
    material = service.get_by_id(material_id)
    return templates.TemplateResponse("material/test_form.html", {
        "request": request, "action_title": "Edit test",
